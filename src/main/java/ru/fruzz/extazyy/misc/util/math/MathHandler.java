package ru.fruzz.extazyy.misc.util.math;
...
public class MathHandler implements Mine {
    public static @NotNull Vector3f calculateNormal(Vec3 start, Vec3 end) {
    ...
    public static Vec3 getInterpolatedPosition(Entity entity, float tickDelta) {
        return new Vec3(Mth.lerp(tickDelta, entity.xo, entity.getX()), Mth.lerp(tickDelta, entity.yo, entity.getY()), Mth.lerp(tickDelta, entity.zo, entity.getZ()));
    }
