...
public class BindSettingsComponent extends Component {
    ...
    public BindSettingsComponent(BindTools component) {
    ...
    public void drawComponent(PoseStack matrixStack, int mouseX, int mouseY) {
       ...
       // FontRenderers.generalgui14.drawString(matrixStack, "C",x + 118.5f, y + 1.5f, enabled ? new Color(207, 54, 54).getRGB() : new Color(102, 102, 102,255).getRGB());
        FontRenderers.umbrellatext16.drawString(matrixStack, option.getName(),x , y -2, new Color(176, 176, 176,255).getRGB());
        ...
        DrawHelper.rectangle(matrixStack, x + 132 - offsetwidth /2, y + 1.4f - 4.5f - offsetheight /2, 16 + offsetwidth , 9 + offsetheight, 2f, new Color(36, 38, 46).getRGB());
       // TestRender.addWindow(matrixStack, x + 132 , y + 1.4f - 4.5f , x + 132 + 16  , y + 1.4f - 4.5f + 9, 1);
        if(bindString.equals("...")) {
            FontRenderers.msSemi24.drawString(matrixStack, bindString.toUpperCase(),x + 135.5f, y - 3 - 4.5f, new Color(176, 176, 176,255).getRGB());
        } else {
            FontRenderers.msSemi16.drawString(matrixStack, bindString.toUpperCase(),x + 133f, y - 1.5f, new Color(176, 176, 176,255).getRGB());
        }
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        ...
        if (DrawHelper.isInRegion(mouseX,mouseY,x + 132, y + 1.4f - 4.5f, 16,9) && mouseButton == 0) {
            System.out.println("sex v2");
            bind = true;
        }
    }
