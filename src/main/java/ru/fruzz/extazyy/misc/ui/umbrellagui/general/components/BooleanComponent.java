...
public class BooleanComponent extends Component {
    ...
    public BooleanComponent(BooleanOption component) {
    ...
    public void drawComponent(PoseStack matrixStack, int mouseX, int mouseY) {
        ...
        FontRenderers.umbrellatext16.drawString(matrixStack, option.getName(),x + 130.5f, y - 1.5f, new Color(176, 176, 176,255).getRGB());

        DrawHelper.rectangle(matrixStack, x + 392, y - 2.5f, 16, 9, 4.3f, enabled ? new Color(57, 28, 31).getRGB() : (enabledragged ?  new Color(50, 29, 33).getRGB() :  new Color(26, 28, 33).getRGB()));

        RenderMcd.drawBlurredShadow(matrixStack , x + 392 - this.animation * 7.90f, y - 2.5f, 8.5f, 8.5f, 6, new Color(17, 19, 23).getRGB());
        DrawHelper.rectangle(matrixStack, x + 392 - this.animation * 7.90f, y - 2.5f, 8.5f, 8.5f, 4f, enabled ? new Color(207, 54, 54).getRGB() : ( enabledragged ?  new Color(154, 78, 78).getRGB() :  new Color(102, 102, 102).getRGB()));
