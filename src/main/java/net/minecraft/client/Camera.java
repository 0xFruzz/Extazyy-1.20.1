...
public class Camera {
   ...
   public void setup(BlockGetter pLevel, Entity pEntity, boolean pDetached, boolean pThirdPersonReverse, float pPartialTick) {
      ...
      if (pDetached) {
         ...
         if(Extazyy.moduleManager.cameraOffset.state) {
            this.move(Extazyy.moduleManager.cameraOffset.x.getValue().floatValue(), Extazyy.moduleManager.cameraOffset.y.getValue().floatValue(), Extazyy.moduleManager.cameraOffset.z.getValue().floatValue());
         } else {
