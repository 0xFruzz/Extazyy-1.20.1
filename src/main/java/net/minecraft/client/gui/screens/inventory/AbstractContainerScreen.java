...
public abstract class AbstractContainerScreen<T extends AbstractContainerMenu> extends Screen implements MenuAccess<T> {
   ...
   public static void customClick(int pSlotId, int pMouseButton, ClickType pType) {
      Mine.mc.gameMode.handleInventoryMouseClick(Mine.mc.player.containerMenu.containerId, pSlotId, pMouseButton, pType,Mine.mc.player);
   }
